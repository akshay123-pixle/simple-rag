...
def initialize_rails() -> None:
    ...
    reserving the 70b model for RAG generation.
    """
    global _rails
...
def guard(message: str) -> tuple[bool, str | None]:
    ...
    with logfire.span("Guardrails Check"):
        ...
        try:
            ...
            logfire.warning(f"Guardrails check bypassed due to rate limit / error: {e}")
            print(f"[Guardrails]: Rate limit / error encountered, bypassing gate.")
            return False, None